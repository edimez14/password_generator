export const metadata = {
    title: "Profile | Password Generator",
    description: "User profile page so they can update their data or delete their accounts",
    keywords: "user, profile, user updata data, data, delete accounts",
